        ...
        <div className="flex flex-col items-center justify-center min-h-screen py-12">
          <div className="text-center space-y-8 max-w-2xl">
            ...
            <p className="text-xl text-gray-600 mt-6">
              Connect with innovative startups, share your journey, and grow together
            ...
            <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8">
              <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 mt-2">Network with other innovative startups</p>
              </div>
              <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow">
                <div className="text-indigo-600 text-2xl mb-3">💡</div>
                <h3 className="text-lg font-semibold text-gray-900">Share</h3>
                <p className="text-gray-600 mt-2">Share your startup journey and updates</p>
              </div>
              <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow">
                <div className="text-indigo-600 text-2xl mb-3">🌟</div>
                <h3 className="text-lg font-semibold text-gray-900">Grow</h3>
                <p className="text-gray-600 mt-2">Learn and grow with the community</p>
              </div>
            </div>
          </div>
        </div>
